...
class AccountTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        for ($i = 0; $i < 40; $i++) {
            ...
            $address_1 = [
                '北海道', '青森県', '秋田県', '山形県', '岩手県', '宮城県', '福島県', '群馬県', '栃木県', '茨城県', '埼玉県', '東京都', '神奈川県', '千葉県', '山梨県', '長野県', '新潟県', '静岡県', '愛知県', '岐阜県',
                '富山県', '石川県', '福井県', '滋賀県', '大阪府', '奈良県', '和歌山県', '三重県', '京都府', '兵庫県', '岡山県', '広島県', '山口県', '鳥取県', '島根県', '香川県', '愛媛県', '高知県', '徳島県', '大分県',
                '佐賀県', '福岡県', '熊本県', '宮崎県', '長崎県', '鹿児島県', '沖縄県'];
            ...
            $telnumber_top = ['050', '070', '080', '090'];
            $email_domain = ['@gmail.com', '@yahoo.co.jp', '@icloud.com'];
            ...
            $email = $email . $email_domain[rand(0, 2)];

            DB::table('accounts')->insert([
                'birthday' => rand(1960, date("Y") - 15) . '年' . rand(1, 12) . '月' . rand(1, 31) . '日',
                'gender' => $gender,
                'address_1' => $address_1[rand(0, 46)],
                'address_2' => '未設定',
                'name' => $full_name,
                'id-name' => $id_name,
                'email' => $email,
                'password' => password_hash('1111', PASSWORD_DEFAULT),
                'tel' => $telnumber_top[rand(0, 2)] . rand(0, 9) . rand(0, 9) . rand(0, 9) . rand(0, 9) . rand(0, 9) . rand(0, 9) . rand(0, 9) . rand(0, 9),
